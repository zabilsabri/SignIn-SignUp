...
<body>
    <main>
        <div class="Fpassword-container">
            <div class="Fpassword-heading-container">
                <h3>CONFIRM PASSWORD</h3>
            </div>
            <div class="Fpassword-exp">
                <p>Choose The Question and Answer It, To Recover Your Password Someday!</p>
            </div>
            <form class="Fpassword-form" action="FpasswordBE.php" method="POST">
                <div class="text-box">
                    <input type="email" class="form-content" name="email" placeholder="Email">
                </div>
                <div class="text-box">
                    <select class="Fpassword-form-content" name="QFpassword" aria-label="Default select example">
                ...
                <button type="submit" name="Fpassword" class="btn btn-dark">CONFIRM</button>
            </form>
        </div>
    </main>
</body>
